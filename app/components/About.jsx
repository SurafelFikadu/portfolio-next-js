    ...
    >
        ...
        transition={{duration: 0.8}} className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            <motion.div
                ...
                <Image src={assets.user_image} alt='user' className='w-full rounded-3xl border' />
            </motion.div>
            ...
            <motion.div
                ...
                <p className='mb-10 max-w-2xl font-Ovo'>
                  Hey my name is Surafel Fikadu and I am Software Enginner, 
                  graduated from ALX Africa speciallized in front-end. I'm 
                  also certify in Responisve web design, JavaScript algorithm 
                  and data structure, front-end development libraries and 
                  Data visualization from freecodecamp.org.
                  And I have an excellent skill in HTML, CSS, JavaScript, 
                  TypeScript, ReactJs, Tailwind-CSS and Python.
                </p>
